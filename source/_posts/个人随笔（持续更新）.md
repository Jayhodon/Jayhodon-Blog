...
![原型经典图](../images/classic-prototype.jpg)
...
![flex-容器属性](../images/flex-container.jpg)

![flex-项目属性](../images/flex-project.jpg)
...
####  vue 内置指令![vue内置指令](../images/vue-command.jpg)
...
![http-cache-2](../images/http-cache-2.jpg)
#### 1、http缓存的分类：
...
![http缓存-强制](../images/http-force-cache.jpg)
...
![http缓存-协商](../images/http-negotiation-cache.jpg)
...
![http缓存-3](../images/http-cache-3.jpg)
